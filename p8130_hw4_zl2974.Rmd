...
\ The Chi-sq statistics value is greater than the critical value(`r qchisq(0.99,2)`) at 95% confidence level, so we reject the null hypothesis that the the swelling symptom is independent to vaccine status.
